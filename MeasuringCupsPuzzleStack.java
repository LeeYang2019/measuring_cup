...
// Main Class File:  (MeasuringCupsPuzzleStack.java)
...
public class MeasuringCupsPuzzleStack implements MeasuringCupsPuzzleADT {
	...
	public void add(MeasuringCupsPuzzleState state) {
		stack.push(state); //add the state to the front of the stack
	}
	...
	public MeasuringCupsPuzzleState remove() {
		...
		return this.stack.pop(); //remove from the top of the stack
	}
	...
	public boolean isEmpty() {
		...
		//if the stack is empty then it is empty
		if (stack.empty())
		{
			return true;
		}

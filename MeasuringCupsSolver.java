...
public class MeasuringCupsSolver {
	...
	public static void main(String[] args) {
		...
		MeasuringCupsPuzzleState startState = 
				new MeasuringCupsPuzzleState(startCupA, startCupB, null);

		Cup goalCupA = new Cup(capacityCupA, goalAmount);
		Cup goalCupB = new Cup(capacityCupB, 0);

		MeasuringCupsPuzzleState goalState = 
				new MeasuringCupsPuzzleState(goalCupA, goalCupB, null);

		MeasuringCupsPuzzle measuringCupsPuzzle = 
				new MeasuringCupsPuzzle(startState, goalState);
